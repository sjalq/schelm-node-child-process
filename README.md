...
V1.1 preserves the standalone 1.0 API and adds parent-before-spawn reservation, registration-before-start, package-observed PGID facts, bounded parent reap/unregister hooks, and an opt-in typed parent-adapter IPC channel for spawned Node workers.
