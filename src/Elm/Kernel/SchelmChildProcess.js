...
var _SchelmChildProcess_isUnix = process.platform !== "win32";
...
var _SchelmChildProcess_cancel=function(id){return _Scheduler_binding(function(callback){var e=_SchelmChildProcess_registry.get(id);if(e){e.reason="cancel";_SchelmChildProcess_beginCleanup(e);}callback(_Scheduler_succeed(_Utils_Tuple0));});};
var _SchelmChildProcess_cancelMany=function(ids){return _Scheduler_binding(function(callback){_List_toArray(ids).forEach(function(id){var e=_SchelmChildProcess_registry.get(id);if(e){e.reason="shutdown";_SchelmChildProcess_beginCleanup(e);}});callback(_Scheduler_succeed(_Utils_Tuple0));});};
